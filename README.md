...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/madtechservices/nova-permission.svg?style=flat-square)](https://packagist.org/packages/madtechservices/nova-permission)
[![Total Downloads](https://img.shields.io/packagist/dt/madtechservices/nova-permission.svg?style=flat-square)](https://packagist.org/packages/madtechservices/nova-permission)

![screenshot 1](https://raw.githubusercontent.com/madtechservices/nova-permission/master/docs/user-resource.png)
...
```bash
composer require madtechservices/nova-permission
```
...
public function tools()
{
    return [
        // ...
        \Madtechservices\NovaPermission\NovaPermissionTool::make(),
    ];
}
```
...
'middleware' => [
    // ...
    \Madtechservices\NovaPermission\ForgetCachedPermissions::class,
],
```
...
public function fields(Request $request)
{
    return [
        // ...
        MorphToMany::make('Roles', 'roles', \Madtechservices\NovaPermission\Role::class),
        MorphToMany::make('Permissions', 'permissions', \Madtechservices\NovaPermission\Permission::class),
    ];
}
```
...
```php
// ...
use Madtechservices\NovaPermission\PermissionBooleanGroup;
use Madtechservices\NovaPermission\RoleBooleanGroup;
...
// ...
use Madtechservices\NovaPermission\PermissionBooleanGroup;
use Madtechservices\NovaPermission\RoleSelect;
